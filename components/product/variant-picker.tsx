...
import { useVariantSelection, VariantAxes, type Axis } from './variant-axes';
 ...
 *
 * The axis buttons and the selection rules — big buttons, unsellable options
 * shown and disabled, the cheapest sellable variant selected first — live in
 * `variant-axes.tsx`, shared with the card's quick-options sheet.
 */
export function VariantPicker({
  ...
  return (
    <div className="space-y-5">
      <VariantAxes options={options} selection={selection} />
